...
const Contribute = ({ title }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = 'service_cqs4c0o'; // Replace with your EmailJS service ID
    const templateId = 'template_uexj8wh'; // Replace with your EmailJS template ID
    const publicKey = 'Ajcc9kYr73ReTCeSr'; // Replace with your EmailJS public key
